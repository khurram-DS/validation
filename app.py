...
def main():
    ...
    if choice == "About":
        ...
        if st.checkbox('click here for Data validation'): 
            ...
            #  1st comparison
                m1 = df['الطاقة الفعلية للمنتجات (الكمية) لعام 2017 للمنتج 1'] > df['الطاقة القصوى بالكمية للمنتج 1']
                m2 = df['الطاقة الفعلية للمنتجات (الكمية) لعام 2018 للمنتج 1'] > df['الطاقة القصوى بالكمية للمنتج 1']
                m3 = df['الطاقة الفعلية للمنتجات (الكمية) لعام 2019 للمنتج 1'] > df['الطاقة القصوى بالكمية للمنتج 1']
                m4 = df['الطاقة الفعلية للمنتجات (الكمية) لعام 2020 للمنتج 1'] > df['الطاقة القصوى بالكمية للمنتج 1']
            ...
            #***********************************************************************************************************************    
                ...
                #1st comparison
                df1['الطاقة الفعلية للمنتجات (الكمية) لعام 2017 للمنتج 1'] = np.where(m1, 'background-color: {}'.format(r), df1['الطاقة الفعلية للمنتجات (الكمية) لعام 2017 للمنتج 1'])
                df1['الطاقة الفعلية للمنتجات (الكمية) لعام 2018 للمنتج 1'] = np.where(m2, 'background-color: {}'.format(r), df1['الطاقة الفعلية للمنتجات (الكمية) لعام 2018 للمنتج 1'])
                df1['الطاقة الفعلية للمنتجات (الكمية) لعام 2019 للمنتج 1'] = np.where(m3, 'background-color: {}'.format(r), df1['الطاقة الفعلية للمنتجات (الكمية) لعام 2019 للمنتج 1'])
                df1['الطاقة الفعلية للمنتجات (الكمية) لعام 2020 للمنتج 1'] = np.where(m4, 'background-color: {}'.format(r), df1['الطاقة الفعلية للمنتجات (الكمية) لعام 2020 للمنتج 1'])
                #2nd comparison
