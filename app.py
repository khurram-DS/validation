...
def main():
    ...
    if choice == "About":
        ...
        if st.checkbox('Show added columns'):
            df['addedvalue2017']=df['قيمة المخزون السنوي من المواد الأولية (د.ك) في نهاية السنة لعام 2017']-df['قيمة المخزون السنوي من المواد الأولية (د.ك) في بداية السنة لعام 2017']+df['إجمالي المبيعات (د.ك) لعام 2017']-df['إجمالي قيمة المواد الأولية (د.ك) لعام 2017']-df['الإجمالي (د.ك) لعام 2017']-df['تكاليف المنشأة/الإجمالي (د.ك) لعام 2017']
            df['addedvalue2018']=df['قيمة المخزون السنوي من المواد الأولية (د.ك) في نهاية السنة لعام 2018']-df['قيمة المخزون السنوي من المواد الأولية (د.ك) في بداية السنة لعام 2018']+df['إجمالي المبيعات (د.ك) لعام 2018']-df['إجمالي قيمة المواد الأولية (د.ك) لعام 2018']-df['الإجمالي (د.ك) لعام 2018']-df['تكاليف المنشأة/الإجمالي (د.ك) لعام 2018']
            df['addedvalue2019']=df['قيمة المخزون السنوي من المواد الأولية (د.ك) في نهاية السنة لعام 2019']-df['قيمة المخزون السنوي من المواد الأولية (د.ك) في بداية السنة لعام 2019']+df['إجمالي المبيعات (د.ك) لعام 2019']-df['إجمالي قيمة المواد الأولية (د.ك) لعام 2019']-df['الإجمالي (د.ك) لعام 2019']-df['تكاليف المنشأة/الإجمالي (د.ك) لعام 2019']
            df['addedvalue2020']=df['قيمة المخزون السنوي من المواد الأولية (د.ك) في نهاية السنة لعام 2020']-df['قيمة المخزون السنوي من المواد الأولية (د.ك) في بداية السنة لعام 2020']+df['إجمالي المبيعات (د.ك) لعام 2020']-df['إجمالي قيمة المواد الأولية (د.ك) لعام 2020']-df['الإجمالي (د.ك) لعام 2020']-df['تكاليف المنشأة/الإجمالي (د.ك) لعام 2020']

            df['Total_cost_2017']=df['إجمالي قيمة المواد الأولية (د.ك) لعام 2017']+df['تكاليف المنشأة/الإجمالي (د.ك) لعام 2017']+df['الإجمالي (د.ك) لعام 2017']
            df['Total_cost_2018']=df['إجمالي قيمة المواد الأولية (د.ك) لعام 2018']+df['تكاليف المنشأة/الإجمالي (د.ك) لعام 2018']+df['الإجمالي (د.ك) لعام 2018']
            df['Total_cost_2019']=df['إجمالي قيمة المواد الأولية (د.ك) لعام 2019']+df['تكاليف المنشأة/الإجمالي (د.ك) لعام 2019']+df['الإجمالي (د.ك) لعام 2019']
            df['Total_cost_2020']=df['إجمالي قيمة المواد الأولية (د.ك) لعام 2020']+df['تكاليف المنشأة/الإجمالي (د.ك) لعام 2020']+df['الإجمالي (د.ك) لعام 2020']
        ...
        if st.checkbox('click here for Data validation'): 
            ...
            #2017    
                data1=df.loc[df['addedvalue2017'] < 0]
                data5=data1['Total_cost_2017']-df['إجمالي المبيعات (د.ك) لعام 2017']
                data2=df.loc[df['addedvalue2017'] > 0]
                data3=df['إجمالي المبيعات (د.ك) لعام 2017']-data2['Total_cost_2017']
                x1= data5 < 0
                x2= data3 < 0
                
            #2018
                data11=df.loc[df['addedvalue2018'] < 0]
                data51=data11['Total_cost_2018']-df['إجمالي المبيعات (د.ك) لعام 2018']
                data21=df.loc[df['addedvalue2018'] > 0]
                data31=df['إجمالي المبيعات (د.ك) لعام 2018']-data21['Total_cost_2018']
                x11= data51 < 0
                x21= data31 < 0
                
             #2019
                data12=df.loc[df['addedvalue2019'] < 0]
                data52=data12['Total_cost_2019']-df['إجمالي المبيعات (د.ك) لعام 2019']
                data22=df.loc[df['addedvalue2019'] > 0]
                data32=df['إجمالي المبيعات (د.ك) لعام 2019']-data22['Total_cost_2019']
                x12= data52 < 0
                x22= data32 < 0
             #2020
                data13=df.loc[df['addedvalue2020'] < 0]
                data53=data13['Total_cost_2020']-df['إجمالي المبيعات (د.ك) لعام 2020']
                data23=df.loc[df['addedvalue2020'] > 0]
                data33=df['إجمالي المبيعات (د.ك) لعام 2020']-data23['Total_cost_2020']
                x13= data53 < 0
                x23= data33 < 0
